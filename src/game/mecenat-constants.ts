...
export const MECENAT_BUILDING_CARDS: Record<string, BuildingCardDef> = {
  ...
  '宝くじ':         { name: '宝くじ',         cost: 2,  assetValue: 10,  tags: [],                  canSell: true,  isWorkplace: true,  count: 2, effect: { kind: 'gain-household', net: 10, take: 20, minHousehold: 20 } },
  ...
  'プレハブ工務店': { name: 'プレハブ工務店', cost: 3,  assetValue: 12, tags: [],                  canSell: true,  isWorkplace: true,  count: 2, effect: { kind: 'build-free-if-cheap', maxAsset: 10 } },
  ...
  '造船所':         { name: '造船所',         cost: 4,  assetValue: 20, tags: ['factory'],         canSell: true,  isWorkplace: true,  count: 3, effect: { kind: 'discard-draw-min-hand', discard: 3, draw: 6, minHand: 3 } },
  ...
  // cost: 5
  '工業団地':       { name: '工業団地',       cost: 5,  assetValue: 22, tags: ['factory'],         canSell: true,  isWorkplace: true,  count: 2, effect: { kind: 'draw-with-build-discount', n: 3 }, constructionDiscount: { condition: 'per-owned-tag', tag: 'factory', discountPerTag: 1 } },
