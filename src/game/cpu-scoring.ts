...
import {
  type ScoreWeights, DEFAULT_WEIGHTS, getPlayerWeights,
  type BeamEvalWeights, getBeamEvalWeights,
} from './cpu-scoring-weights'

export type { ScoreWeights, BeamEvalWeights }
export { getPlayerWeights }
